...
States.Level2.prototype = {
	...
	***************************/
	...
	{
        var bg = this.game.add.image(0, 0, "bgHome2");
        bg.fixedToCamera = true;
        
		this.map = this.add.tilemap("tm-level2");
        ...
        this.cameraPoint = new CameraPoint(this.game, 200, this.world.height/2, 100);
	...
	***************************/
    ...
    {
    this.audio.level2.volume = 0;
    this.audio.pose.volume = 1
    }
        else
        {
        this.audio.level2.volume = 1;
	...
	***************************/
	update:function()
	{
        ...
        {
        this.endLevel = true;
        var transitionScreen = new UILevelInfos(this.game, true, false, "Old Hill Valley");
		this.add.existing(transitionScreen);
		
        this.audio.level2.stop();
        this.audio.pose.stop();
        
		this.game.time.events.add(Phaser.Timer.SECOND * 3, this.launchLevel3, this); 
        }
	}
}