...
States.Level3.prototype = {
	...
	***************************/
	...
	{
        var bg = this.game.add.image(0, 0, "bgHome3");
        bg.fixedToCamera = true;
        
		this.map = this.add.tilemap("tm-level3");
	...
	***************************/
    ...
    {
    this.audio.level3.volume = 0;
    this.audio.pose.volume = 1
    }
        else
        {
        this.audio.level3.volume = 1;
	...
	***************************/
	update:function()
	{
        ...
        {
        this.endLevel = true;
        var transitionScreen = new UILevelInfos(this.game, true, false, "YOU WON !");
		this.add.existing(transitionScreen);
		
        this.audio.level3.stop();
        this.audio.pose.stop();
        
		this.game.time.events.add(Phaser.Timer.SECOND * 3, this.launchMenu, this); 
        }
	}
}